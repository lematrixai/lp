...
const HeroSection = () => {
  ...
  return (
    <main className="relative min-h-screen bg-primary/5 dark:bg-black flex flex-col md:flex-row items-center justify-center px-4 md:px-12 py-12 gap-8 overflow-hidden">
      ...
      <div className="flex-1 flex items-start justify-center w-full max-w-lg z-20 max-md:hidden">
        <WorldMap
          dots={[
            {
              start: { lat: 64.2008, lng: -149.4937 }, // Alaska (Fairbanks)
              end: { lat: -25.8231, lng: 36.2695 },   // Dar es Salaam, Tanzania (moved slightly left)
            },
            {
